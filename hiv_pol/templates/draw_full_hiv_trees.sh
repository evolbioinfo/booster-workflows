...
gotree download itol -f svg -i $(basename $tbeurl) -c !{configtbe} -o !{outprefix}_tree_tbe.svg
gotree download itol -f svg -i $(basename $fbpurl) -c !{configfbp} -o !{outprefix}_tree_fbp.svg
