...
nextflow run trees.nf --datadir ../data/mammals --resultDir results/fasttree

# We also infer ref and boot trees using RAxML (+rapid bootstrap)
nextflow run raxmltrees.nf --resultDir results/raxml

# We compute support for FastTree trees
nextflow run supports.nf --datadir results/fasttree --resultdir results/fasttree

# We compute support for RAxML rapid bootstrap
nextflow run supports.nf --datadir results/raxml --resultdir results/raxml

# We compare FastTree inferred tree with ncbi tree (quartets)
nextflow run compare_quartets.nf --div1tree  results/fasttree/trees/ref_1_31144.nw.gz  \
...
nextflow run compare_quartets.nf --div1tree  results/raxml/trees/ref_1_31144.nw.gz  \
                                 --truetree  ../data/ncbitax/ncbi.nw                \
...
# We generate figures
nextflow run plot.nf --tbetreefasttree "results/fasttree/support/1_31144_tbe.nw"     \
