...
nextflow run trees.nf --resultdir 'results/indelible'\
	              --rateshuffle 0.0              \
                      --raterecombi 0.0              \
                      --lengthrecombi 0              \
                      --raterogue 0.00               \
...
nextflow run supports.nf --datadir 'results/indelible'                                                \
...
nextflow run compare_quartets.nf --div1tree 'results/indelible/trees/ref_1_65512081.nw.gz'                  \
...
nextflow run trees.nf --resultdir 'results/indelible0.5'\
                      --rateshuffle 0.5                 \
                      --raterecombi 0.0                 \
                      --lengthrecombi 0                 \
                      --raterogue 0.05                  \
...
nextflow run supports.nf --datadir 'results/indelible0.5'                                             \
                         --resultdir 'results/indelible0.5'                                           \
                         --truetree '../mammals_COI5P/results/fasttree/trees/ref_phyml_1_31144.nw.gz' \
                         --roguefile 'results/indelible0.5/aligns/rogues.txt'

nextflow run compare_quartets.nf --div1tree 'results/indelible0.5/trees/ref_1_65512081.nw.gz'                 \
                                 --truetree '../mammals_COI5P/results/fasttree/trees/ref_phyml_1_31144.nw.gz' \
...
# Figure S12
nextflow run plot.nf  --tbetree "results/indelible/supports/1_65512081_tbe.nw"         \
